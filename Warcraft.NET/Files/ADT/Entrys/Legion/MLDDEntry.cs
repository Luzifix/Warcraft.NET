...
namespace Warcraft.NET.Files.ADT.Entrys.Legion
{
    ...
    public class MLDDEntry
    {
        ...
        /// </summary>
        public MLDDFlags Flags { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="MLDDEntry"/> class.
        /// </summary>
        /// <param name="data">ExtendedData.</param>
        public MLDDEntry(byte[] data)
        {
